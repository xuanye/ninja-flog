...
export class Background {
    ...
    addTo(parent) {
        ...
        this.bgBack.width = this.state.width * 1.2;
        ...
        this.bgFront.width = this.state.width * 1.2;
        ...
        this.cloudsBack.width = this.state.width * 1.2;
        ...
        this.cloudFront.width = this.state.width * 1.2;
